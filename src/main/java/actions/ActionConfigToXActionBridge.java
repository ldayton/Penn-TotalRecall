...
/**
 * Bridge class that converts ActionConfig objects to XAction objects.
 * This allows the old ShortcutManager to work with the new ActionsManager system
 * without requiring a complete rewrite of the shortcut management UI.
 */
public class ActionConfigToXActionBridge {
    ...
    public static ActionConfig convertToActionConfig(XAction xAction) {
        return new ActionConfig(
                xAction.className(),
                xAction.name(),
                xAction.tooltip() != null ? java.util.Optional.of(xAction.tooltip()) : java.util.Optional.empty(),
                xAction.enumValue() != null ? java.util.Optional.of(xAction.enumValue()) : java.util.Optional.empty(),
                xAction.shortcut() != null ? java.util.Optional.of(xAction.shortcut()) : java.util.Optional.empty()
        );
    }
}
