 ...
 *
 * <p>Used by <code>IdentifiedMultiActions</code> and <code>IdentifiedSingleActions</code> to
 * automatically associate themselves with names, tooltips, and shortcuts.
 */
public class XActionManager {
    ...
    public static void registerInputMap(
            UpdatingAction action, Enum<?> e, String mapKey, InputMap map) {
        String id = makeId(action, e);
