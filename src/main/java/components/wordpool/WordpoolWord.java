...
public class WordpoolWord implements Comparable<WordpoolWord> {
     ...
     * @param num Index of the word in the file from which it was derived (0-based numbering), or -1
     *     if not from any file (intrusion)
     */
    ...
    /**
     * Lst words are placed before general wordpool words. Otherwise sorting is done alphabetically.
     *
     * <p>{@inheritDoc}
     */
    ...
    /**
     * This word is equal to another object if it too is a <code>WordpoolWord</code> and they share
     * the same text.
     *
     * <p>{@inheritDoc}
     */
