...
public class AnnotationFileParser {
    ...
    private static final Pattern commentPattern =
            Pattern.compile("(.*)" + Constants.inlineCommentIndicator + ".*");
     ...
     *
     * <p>Proceeds line by line, parsing at most one <code>Annotation</code> per line.
     *
     * @param file The file to be parsed
     * @return A <code>List</code> of <code>Annotations</code> from the file, or <code>null</code>
    ...
    public static void prependHeader(File oFile, String annotatorName) throws IOException {
        ...
        File tmpFile =
                new File(oFile.getAbsolutePath() + "." + Constants.deletionTempFileExtension);
        ...
        String utcString =
                DateFormat.getDateInstance(DateFormat.LONG).format(date)
                        + Constants.annotationFileDelimiter
        ...
        String[] javaPropertyStrings = {
            "java.runtime.version", "java.specification.name", "java.specification.vendor",
                    "java.specification.version", "java.vendor", "java.version",
    ...
    private static void writePropertyLine(String name, String[] properties, BufferedWriter fw)
            throws IOException {
