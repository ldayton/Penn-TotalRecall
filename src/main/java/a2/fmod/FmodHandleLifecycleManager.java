 ...
 * 
 * <p>This class ensures that only handles from the current generation are valid, providing
 * atomic invalidation of all previous handles when a new audio file is loaded.
 * 
...
class FmodHandleLifecycleManager {
    ...
    /**
     * Creates a new audio handle for the given audio resource.
     * This atomically invalidates any previously created handles by incrementing the generation.
     *
