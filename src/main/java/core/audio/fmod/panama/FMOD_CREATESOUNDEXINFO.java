 ...
 * inclusionlistnum; FMOD_SOUND_PCMREAD_CALLBACK pcmreadcallback; FMOD_SOUND_PCMSETPOS_CALLBACK
 * pcmsetposcallback; FMOD_SOUND_NONBLOCK_CALLBACK nonblockcallback; const char *dlsname; const char
 * *encryptionkey; int maxpolyphony; void *userdata; FMOD_SOUND_TYPE suggestedsoundtype;
 * FMOD_FILE_OPEN_CALLBACK fileuseropen; FMOD_FILE_CLOSE_CALLBACK fileuserclose;
 * FMOD_FILE_READ_CALLBACK fileuserread; FMOD_FILE_SEEK_CALLBACK fileuserseek;
 * FMOD_FILE_ASYNCREAD_CALLBACK fileuserasyncread; FMOD_FILE_ASYNCCANCEL_CALLBACK
 * fileuserasynccancel; void *fileuserdata; int filebuffersize; FMOD_CHANNELORDER channelorder;
 * FMOD_SOUNDGROUP *initialsoundgroup; unsigned int initialseekposition; FMOD_TIMEUNIT
 * initialseekpostype; int ignoresetfilesystem; unsigned int audioqueuepolicy; unsigned int
 * minmidigranularity; int nonblockthreadid; FMOD_GUID *fsbguid; } }
 */
