...
sed -i '' 's/CurAudio\.getMaster/audioState.getCalculator/g' src/main/java/components/waveform/WaveformDisplay.java
...
sed -i '' 's/CurAudio\.getMaster/audioState.getCalculator/g' src/main/java/components/waveform/WaveformBuffer.java
